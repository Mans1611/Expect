...
/*
db.shop.insertMany([
    {product:"milk",price:12.5,customer:"mans"},
    {product:"water",price:7.5,customer:"hassen"},
    {product:"bread",price:7.2,customer:"marim"},
    {product:"ice cream",price:12.5,customer:"ahmed"},
    {product:"gum",price:.5,customer:"mans"},
    {product:"water",price:7.5,customer:"bassent"},
])*/
// db.shop.aggregate([
//     {$match:{customer : {$in :["mans","ahmed"]}} },
